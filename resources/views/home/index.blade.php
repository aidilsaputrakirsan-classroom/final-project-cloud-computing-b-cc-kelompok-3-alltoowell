            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="md:col-span-2">
                    <div class="relative">
                        ...
                        <input type="text" id="search-input" placeholder="Cari nama kamar atau lokasi..."
                ...
                <div>
                    <select id="price-filter" onchange="filterRooms()"
                            class="w-full h-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary px-3">
                ...
                <div class="room-card bg-white rounded-xl overflow-hidden shadow-lg border-0 animate-fade-in" style="animation-delay: ${i * 0.1}s">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex items-center justify-between pt-4 border-t">
                            ...
                            <button onclick="alert('Detail kamar ${room.id}')"
                                    class="px-4 py-2 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all flex items-center gap-2">
                                Detail
